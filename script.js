...
const regioes = {
    '11': ['Altamira do Paraná', 'Araruna', 'Barbosa Ferraz', 'Boa Esperança', 'Campina da Lagoa', 'Campo Mourão', 'Corumbataí do Sul', 'Engenheiro Beltrão', 'Farol', 'Fênix', 'Goioerê', 'Iretama', 'Janiópolis', 'Juranda', 'Luiziana', 'Mamborê', 'Moreira Sales', 'Nova Cantu', 'Terra boa', 'Peabiru', 'Quinta do Sol', 'Rancho Alegre d\'Oeste', 'Roncador', 'Ubiratã', 'Nova tebas', 'Pitanga', 'Boa Ventura do São Roque', 'Santa maria do oeste', 'Mato Rico'],
    '12': ['Altônia', 'Alto Paraíso', 'Brasilândia do Sul', 'Cafezal do Sul', 'Francisco Alves', 'Iporã', 'Ivaté', 'Ivatuba', 'Mariluz', 'Maria Helena', 'Nova Olímpia', 'Pérola', 'Perobal', 'São Jorge do Patrocínio', 'Tapira', 'Umuarama', 'Xambrê'],
    '13': ['Cianorte', 'Cidade Gaúcha', 'Guaporema', 'Indianópolis', 'Japurá', 'Jussara', 'Rondon', 'São Manoel do Paraná', 'São Tomé', 'Tapejara', 'Terra Boa', 'Tuneiras do Oeste'],
    '14': ['Alto Paraná', 'Amaporã', 'Cruzeiro do Sul', 'Diamante do Norte', 'Guairaçá', 'Inajá', 'Itaúna do Sul', 'Loanda', 'Mirador', 'Nova Aliança do Ivaí', 'Nova Londrina', 'Paranacity', 'Paranapoema', 'Paranavaí', 'Planaltina do Paraná', 'Porto Rico', 'Santa Cruz de Monte Castelo', 'Santa Isabel do Ivaí', 'Santa Mônica', 'Santo Antônio do Caiuá', 'São Carlos do Ivaí', 'São João do Caiuá', 'São Pedro do Paraná', 'Tamboara', 'Terra Rica'],
    '15': ['Ângulo', 'Astorga', 'Doutor Camargo', 'Floresta', 'Floraí', 'Iguaraçu', 'Itambé', 'Itaguajé', 'Mandaguaçu', 'Mandaguari', 'Marialva', 'Maringá', 'Munhoz de Melo', 'Nossa Senhora das Graças', 'Nova Esperança', 'Ourizona', 'Paiçandu', 'Presidente Castelo Branco', 'Santa Fé', 'Santo Inácio', 'São Jorge do Ivaí', 'Sarandi'],
    '16': ['Apucarana', 'Arapongas', 'Bom Sucesso', 'Cambira', 'Califórnia', 'Jandaia do Sul', 'Kaloré', 'Marilândia do Sul', 'Marumbi', 'Mauá da Serra', 'Novo Itacolomi', 'Rio Bom', 'Sabáudia'],
    '17': ['Alvorada do Sul', 'Bela Vista do Paraíso', 'Cambé', 'Ibiporã', 'Londrina', 'Primeiro de Maio', 'Porecatu', 'Prado Ferreira', 'Rolândia', 'Sertanópolis', 'Tamarana'],
    '18': ['Andirá', 'Bandeirantes', 'Congonhinhas', 'Itambaracá', 'Leópolis', 'Nova América da Colina', 'Nova Fátima', 'Ribeirão do Pinhal', 'Santa Amélia', 'Santa Mariana', 'Santo Antônio do Paraíso', 'São Jerônimo da Serra', 'São Sebastião da Amoreira', 'Uraí'],
    '19': ['Abatiá', 'Barra do Jacaré', 'Cambará', 'Carlópolis', 'Conselheiro Mairinck', 'Guapirama', 'Ibaiti', 'Jaboti', 'Jacarezinho', 'Japira', 'Joaquim Távora', 'Jundiaí do Sul', 'Pinhalão', 'Ribeirão Claro', 'Ribeirão do Pinhal', 'Salto do Itararé', 'Santana do Itararé', 'Siqueira Campos', 'Tomazina', 'Wenceslau Braz'],
    '21': ['Cândido de Abreu', 'Curiúva', 'Faxinal', 'Imbaú', 'Ortigueira', 'Reserva', 'Rosário do Ivaí', 'Telêmaco Borba'],
    '22': ['Ariranha do Ivaí', 'Borrazópolis', 'Cruzmaltina', 'Godoy Moreira', 'Grandes Rios', 'Ivaiporã', 'Jardim Alegre', 'Lidianópolis', 'Lunardelli', 'Manoel Ribas', 'Nova Tebas', 'Rio Branco do Ivaí', 'São João do Ivaí', 'São Pedro do Ivaí']
};
